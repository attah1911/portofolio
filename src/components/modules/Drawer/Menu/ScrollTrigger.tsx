    ...
    <AnimateOnView config={MenuDrawerScrollTriggerAnim}>
      <div className='fixed top-4 right-4 z-60 has-focus-visible:transform-[scale(1)]! has-data-[state=open]:transform-[scale(1)]! sm:top-8 sm:right-8'>
        <MenuDrawerScrollTriggerClient
          ...
          {...props}
        >
          <PiListBold className='transition-[transform,opacity] duration-150 group-data-[state=open]/button:scale-50 group-data-[state=open]/button:opacity-0' />

          <PiXBold className='absolute transition-[transform,opacity] duration-150 group-data-[state=closed]/button:scale-50 group-data-[state=closed]/button:opacity-0' />
