        ...
        >
          ...
          >
            <div className='flex gap-0.5'>
              ...
              >
                <PiPaperPlaneTiltFill /> {t.action.label}
              </MagneticLink>
            </div>
          ...
          <MouseTrail.Container>
            <ScrollYLines className='inset-x-[calc(var(--w)*0.025)] top-24 bottom-[12%]'>
              <MouseTrail
                items={[
                  <PiSmileyFill key='smile' />,
                  <PiRocketLaunchFill key='rocket' />,
                  <PiPaperPlaneTiltFill key='paper-plane' />,
                  <PiLightningFill key='bolt' />,
                  <PiGlobeFill key='globe' />,
                  <PiHeartFill key='heart' />,
                  <PiTrophyFill key='trophy' />
                ]}
                className='text-8xl'
              />
            </ScrollYLines>
